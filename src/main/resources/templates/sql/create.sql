...
ALTER TABLE "C##SEMI".HASHTAGS_CONN ADD CONSTRAINT HASHTAGS_CONN_HASHTAGS_FK FOREIGN KEY (HASH_ID) REFERENCES "C##SEMI".HASHTAGS(HASH_ID);
ALTER TABLE "C##SEMI".HASHTAGS_CONN ADD CONSTRAINT HASHTAGS_CONN_GUIDE_FK FOREIGN KEY (CONN_ID,BOARD_ID) REFERENCES "C##SEMI".GUIDE(GUIDE_ID,BOARD_ID);
ALTER TABLE "C##SEMI".HASHTAGS_CONN ADD CONSTRAINT HASHTAGS_CONN_SOLUTION_FK FOREIGN KEY (CONN_ID,BOARD_ID) REFERENCES "C##SEMI".SOLUTION(SOLUTION_ID,BOARD_ID);
ALTER TABLE "C##SEMI".HASHTAGS_CONN ADD CONSTRAINT HASHTAGS_CONN_LAB_FK FOREIGN KEY (CONN_ID,BOARD_ID) REFERENCES "C##SEMI".LAB(LAB_ID,BOARD_ID);
ALTER TABLE "C##SEMI".HASHTAGS_CONN ADD CONSTRAINT HASHTAGS_CONN_COUNSELING_FK FOREIGN KEY (CONN_ID,BOARD_ID) REFERENCES "C##SEMI".COUNSELING(COUNSELING_ID,BOARD_ID);

ALTER TABLE "C##SEMI".MEMBER_SCRAP ADD CONSTRAINT MEMBER_SCRAP_MEMBER_FK FOREIGN KEY (MEMBER_ID,BOARD_ID) REFERENCES "C##SEMI"."MEMBER"(MEMBER_ID,BOARD_ID);

ALTER TABLE "C##SEMI".MEMBER_COMMENT ADD CONSTRAINT MEMBER_COMMENT_SELF_FK FOREIGN KEY (PARENT_COMMENT_ID) REFERENCES "C##SEMI".MEMBER_COMMENT(COMMENT_ID);
ALTER TABLE "C##SEMI".MEMBER_COMMENT ADD CONSTRAINT MEMBER_COMMENT_MEMBER_FK FOREIGN KEY (CREATER) REFERENCES "C##SEMI"."MEMBER"(MEMBER_ID);

ALTER TABLE "C##SEMI".LAB_DETAIL_INGREDIENT ADD CONSTRAINT LAB_DETAIL_INGREDIENT_LAB_FK FOREIGN KEY (LAB_ID) REFERENCES "C##SEMI".LAB(LAB_ID);

ALTER TABLE "C##SEMI".LAB_DETAIL_STEP ADD CONSTRAINT LAB_DETAIL_STEP_LAB_FK FOREIGN KEY (LAB_ID) REFERENCES "C##SEMI".LAB(LAB_ID);

ALTER TABLE "C##SEMI".COUNSELING ADD CONSTRAINT COUNSELING_MEMBER_FK FOREIGN KEY (CREATER) REFERENCES "C##SEMI"."MEMBER"(MEMBER_ID);
