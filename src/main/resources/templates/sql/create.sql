...
ALTER TABLE "C##SEMI".MEMBER_COMMENT ADD CONSTRAINT MEMBER_COMMENT_SELF_FK FOREIGN KEY (PARENT_COMMENT_ID) REFERENCES "C##SEMI".MEMBER_COMMENT (COMMENT_ID) ON DELETE CASCADE;
