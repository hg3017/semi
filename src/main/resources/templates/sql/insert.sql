...
-- img_list(lab)
insert into IMG_LIST (IMG_LIST_ID, BOARD_ID, FILE_PATH, IMG_PRIORITY, CREATE_DATE, MODIFY_DATE, POST_ID) values(IMG_LIST_SEQ.NEXTVAL,20,'guide3.jpg'  ,1,SYSDATE,'2024.12.16',1);
insert into IMG_LIST (IMG_LIST_ID, BOARD_ID, FILE_PATH, IMG_PRIORITY, CREATE_DATE, MODIFY_DATE, POST_ID) values(IMG_LIST_SEQ.NEXTVAL,20,'guide3.jpg'  ,2,SYSDATE,'2024.12.16',1);
insert into IMG_LIST (IMG_LIST_ID, BOARD_ID, FILE_PATH, IMG_PRIORITY, CREATE_DATE, MODIFY_DATE, POST_ID) values(IMG_LIST_SEQ.NEXTVAL,20,'guide3_1.jpg',3,SYSDATE,'2024.12.16',1);
insert into IMG_LIST (IMG_LIST_ID, BOARD_ID, FILE_PATH, IMG_PRIORITY, CREATE_DATE, MODIFY_DATE, POST_ID) values(IMG_LIST_SEQ.NEXTVAL,20,'guide3_2.jpg',4,SYSDATE,'2024.12.16',1);
